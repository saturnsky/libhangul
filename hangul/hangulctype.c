...
{
    return (c >= 0x1100 && c <= 0x1112) || (c >= 0xe000 && c <= 0xe012);
}
...
{
    return (c >= 0x1161 && c <= 0x1175) || (c >= 0xe061 && c <= 0xe075);
}
...
{
    return (c >= 0x11a7 && c <= 0x11c2) || (c >= 0xe0a7 && c <= 0xe0c2);
}
...
hangul_jamo_to_cjamo(ucschar c)
{
    ...
    static unsigned short jamo_virtual_table[] = {
	0x3131,     /* 0xe000 */
	0x3132,     /* 0xe001 */
	0x3134,     /* 0xe002 */
	0x3137,     /* 0xe003 */
	...
	ret = jamo_virtual_table[c - 0xe000];
    }
...
hangul_jamo_to_syllable(ucschar choseong, ucschar jungseong, ucschar jongseong)
{
    ...
    if (choseong >= 0xe000)
	choseong = choseong - 0xe000 + 0x1100;
    if (jungseong >= 0xe000)
	jungseong = jungseong - 0xe000 + 0x1100;
    if (jongseong >= 0xe000)
	jongseong = jongseong - 0xe000 + 0x1100;
